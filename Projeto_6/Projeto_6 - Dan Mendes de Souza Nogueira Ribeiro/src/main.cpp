...
/**
 * @brief Ponto de entrada do sistema. Realiza a simulação polimórfica e validação de memória.
 */
int main()
{
    ...
    {
        std::cout << std::endl
                  << "Senha ou nome de usuario errado" << std::endl;

        delete usuarioAd1;
    }

    usuarioAdmin *usuarioAd2 = new usuarioAdmin(2, "FulanoAdmin2", "ABC002");
