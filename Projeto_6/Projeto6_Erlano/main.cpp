...
int main() {
    ...
    Aluno* aluno = new Aluno("João Silva", "joao@gmail.com", "Aluno", "1234", "2023001", "Engenharia", {"Matemática", "Física"});
    Professor* professor = new Professor("Maria Souza", "maria@gmail.com", "Professor", "abcd", "Matemática", {"Cálculo", "Álgebra"});
    FuncionarioAdministrativo* funcionario = new FuncionarioAdministrativo("Carlos Mendes", "carlos@gmail.com", "Funcionario", "senha123", "RH", "Assistente");
    Monitor* monitor = new Monitor("Ana Paula", "ana@gmail.com", "Monitor", "senha456", "2023002", "Computação", {"Estrutura de Dados"}, "Programação", {"Lógica de Programação"});
