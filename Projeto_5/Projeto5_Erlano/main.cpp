...
int main() {
    ...
    Aluno* aluno = new Aluno("Erlano", "erlanosousa10@gmail.com", "Aluno", "2023001", "ADS", {"POO", "Engenharia de Software"});
    Professor* professor = new Professor("Isaac Miranda", "isaacpoomiranda@gmail.com", "Professor", "Programação", {"POO", "Banco de Dados"});
    FuncionarioAdministrativo* funcionario = new FuncionarioAdministrativo("Rogilson", "rogilson157@gmail.com", "Funcionario", "RH", "Adminstrador do ônibus");
    Monitor* monitor = new Monitor("Ivan", "Ivandoidin@gmail.com", "Monitor", "2023002", "Programação", {"Estrutura de dados", "Banco de Dados"}, "Programação", {"Lógica de programação", "Tecnologias Web"});
