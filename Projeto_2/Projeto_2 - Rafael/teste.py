...
def main():
    ...
    seguro_carro = SeguroCarro(cliente1, [carro1, carro2], 1500.0, "01/01/2024 a 01/01/2025")
    ...
    cliente2 = Cliente("Rafael Maciel", "987.654.321-00")

    # Criação de uma moto
    moto = Moto("Honda", "Bros", 2024, "MOT-4321")
