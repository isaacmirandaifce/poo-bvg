...
void mostrarcliente(cliente &clienteAdici)
{
    ...
    {
        std::cout << std::endl
                  << "O usuário ainda não foi definido." << std::endl;
    }
    else
    {
        std::cout << std::endl
                  << "O usuário é " << clienteAdici.getNome() << std::endl;

        std::cout << std::endl
                  << "O CPF do usuário " << clienteAdici.getNome() << " é " << clienteAdici.getCPF() << std::endl;
    }
}
...
void mostrarSeguroAuto(seguroAuto &Mostra)
{
    ...
    {
        std::cout << std::endl
                  << "O veículo ainda não foi definido ao seguro." << std::endl;
    }
    else
    {
        std::cout << std::endl
                  << "O ano do carro é " << Mostra.getAno() << std::endl;
        std::cout << std::endl
                  << "A placa do carro é " << Mostra.getPlacaCarro() << std::endl;
    }
}
...
void mostrarSeguroVida(seguroVida &Mostra)
{
    ...
    {
        std::cout << std::endl
                  << "O seguro de vida ainda não foi definido" << std::endl;
    }
    else
    {
        std::cout << std::endl
                  << "A idade do segurado é " << Mostra.getIdade() << std::endl;
        std::cout << std::endl
                  << "A causa do segurado é " << Mostra.getCausa() << std::endl;
    }
}
...
void mostrarSeguroResi(seguroResidencial &Mostra)
{
    ...
    {
        std::cout << std::endl
                  << "A residência ainda não foi definida ao seguro." << std::endl;
    }
    else
    {
        std::cout << std::endl
                  << "O endereço do imovel segurado é " << Mostra.getEndereco() << std::endl;
        std::cout << std::endl
                  << "O tipo de imovel segurado é " << Mostra.getTipoImovel() << std::endl;
    }
}