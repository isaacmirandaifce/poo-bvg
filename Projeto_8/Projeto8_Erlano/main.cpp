...
void gerarDadosMockados() {
    // ==== Alunos ====
    alunos.clear();
    alunos.push_back(Aluno("Rafael Maciel", "rafael@ifce.edu.br", "Aluno", "123", "2023123", "ADS", {"POO", "IHC"}));
    alunos.push_back(Aluno("Erlano Benevides", "joana@ifce.edu.br", "Aluno", "456", "2023124", "ADS", {"POO", "Redes"}));
    alunos.push_back(Aluno("Helena", "Lenis@ifce.edu.br", "Aluno", "789", "2023125", "Zootecnia", {"Calc", "Fisica"}));
    ...
    professores.push_back(Professor("Augustavo Feitosa", "luizaugustavo@ifce.edu.br", "Professor", "pass789", "Matemática", {"Calc"}));
