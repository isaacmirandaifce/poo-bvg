...
void Persistencia::salvarProfessores(const std::string& caminho, const std::vector<Professor>& profs) {
    ...
    for (const auto& p : profs) {
        ...
        // área (não há getter público para áreaDeAtuacao na interface; usamos gerarRelatorio em última instância)
        // Para compatibilidade usamos string vazia se não houver método público.
        out << "" << ";";
