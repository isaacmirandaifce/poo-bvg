...
class TestAutenticacao(unittest.TestCase):
    def setUp(self):
        ...
        # CORREÇÃO: Adicionado argumento 'disciplinas_ministradas' para o teste não quebrar.
        self.professor = Professor(
            nome="Dra. Ana Costa", id_usuario=201, senha="prof_abc", departamento="CC", 
            disciplinas_ministradas=["Cálculo I"]
        )
