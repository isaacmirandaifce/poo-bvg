...
int main() {
    ...
    // Criando alunos
    Aluno a1("Rafael Maciel", "rafagrande934@gmail.com", "Aluno", "123", "2023001", "ADS", {"POO", "ED"});
    Aluno a2("Marco Rocha", "marcorocha2@gmail.com", "Aluno", "456", "2023002", "ADS", {"BD", "LP"});
    Aluno a3("Gabriel Severo", "gabrielsevergoin7@gmail.com", "Aluno", "789", "2023003", "ADS", {"POO", "ED"});
    Aluno a4("Herlano Benevides", "herlanoben10@gmail.com", "Aluno", "101", "2023004", "Zootecnia", {"Calc", "Fisica"});
