...
int main() {
    ...
    Aluno a3("Guilherme Alves", "guilhermegaav77@gmail.com", "Aluno", "789", "2023003", "ADS", {"POO", "ED"});
    Aluno a4("Helena", "helena@gmail.com", "Aluno", "101", "2023004", "Zootecnia", {"Calc", "Fisica"});
